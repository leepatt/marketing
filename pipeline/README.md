...
4. `python3 video/captions-highlight.py reel.words.json caps.ass` — the approved Craftons style (green Inter Bold, 2 lines x 2 words, spoken word flips to white in a green box; `RAISE=t:px` lifts it over on-page buttons).
