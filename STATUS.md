...
- [x] **Caption-style research** → `research/2026-caption-styles.md` (taxonomy, data, top 5). **The five rendered variants (hook card/steps, UI callouts, lower-third, knockout, black highlight) were rejected by Lee — don't re-pitch. Lee is bringing caption references; build to those.**
