...
## The three inputs → one voice
- **Inspiration accounts** (July, Bellroy, Gozney): calm, confident, short, benefit-led; restraint =
  premium; soft CTAs; education framing. **Hommey:** the warmth + community framing ("by you") — but
  NOT the consumer-cutesy tone.
- **Building trade** (Bowens / Big River / Bunnings): real jargon + tradie directness.
- **Craftons brand voice** (`BRAND.md`): builder-to-builder; confident-not-boastful; "we" = Craftons,
  "you" = the builder; explain *why it matters*, not *what it is*; no marketing words.

## The persona (one line)
**A sharp Aussie builder who also gets design — talking to another pro on site.** Confident, warm,
a bit dry. Proud of the work, allergic to fluff. Speaks to builders *and* architects.

## Brand tone vs caption tone
...
- **Body:** 1–3 short lines. The value or the story. Plain.
- **CTA (soft, optional):** one line, per lane.
- **Hashtags:** a tight set (~5–10), below the fold. Branded (#BuiltWithCraftons) + category.

## Hook patterns (from the swipe file)
- The strong opinion: *"Site-bent radius is dead. Here's why."*
- The number: *"600mm radius. 48-hour lead time."*
- The pain / POV: *"Architect specced a 2.4m radius and walked off. Here's how we'd quote it."*
- The teach: *"How to set out a curved wall so it doesn't crack."*
- The reveal: *"Flat sheet in. Perfect curve out."*
...
## Worked examples
**Corporate → Craftons:**
❌ *"Proud to introduce our innovative curved plywood solutions, engineered for quality and precision."*
✅ *"Curved walls without the bog-and-sand. Radius Pro turns up cut to your set-out — ready to fix."*
