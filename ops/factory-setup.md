...
**Sit down and actually map out the workshop.** Design the layout: where material goes, where stock goes,
where the assembly area sits, where the machine feeds from and to.

Reason it's first, not just on the list: the pallet racking position, where the panel saw ends up, and
where the assembly area lives are all layout decisions. Installing racking before the map is drawn means
moving it twice.

---

## P1 — Priority (blocking a working factory)

### Dust extraction — called out as a priority
- [ ] Rejig the dust extraction unit
- [ ] New hose
- [ ] New dust unit / ducting for the machine
- [ ] Dust bags
- [ ] _(Later, not now)_ Upgrade the extractor — "doesn't quite cut it, but it's fine for now" → see P3
...
- [ ] Offcuts in the corner — sort: some to the bin, some kept
- [ ] Three packs of **battens** → send back up to Melbourne

---

## P2 — Office & tool area (make it usable)

The office **structure is complete and structurally sound** — this is fit-out, not building.

### Office
- [ ] **Floor** — it's very cold in there, needs some sort of floor covering
- [ ] **Line one of the walls**
- [ ] **Skylight window** — clear sheet, acrylic or similar. **Check the offcuts first** before buying
- [ ] **Desk**
- [ ] **Door lock**
- [ ] **Lighting** — a little bit needed

### Acoustics — soundproof the office more
- [ ] Finish the remaining **cladding**
...
- [ ] **Sell the saw on Marketplace** (the one already earmarked for sale — separate from the panel saw)
- [ ] **Upgrade the dust extractor** — the current one is adequate for now, will need replacing eventually
- [ ] **Automatic feeder** — "something needs to happen with that", no decision yet. Probably worth keeping
- [ ] **Rolling tables** — probably keep, they'll be useful for something. Just move them out of the way
...
- **Nixon's clean-up** — did a great job.
- **Office structure** — complete and sound.
